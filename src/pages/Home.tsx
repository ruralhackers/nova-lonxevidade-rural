...
import { Target, Dog, Palette, MessageCircle, Calendar, Activity, Leaf } from 'lucide-react';
    ...
    <div className="min-h-screen" style={{ backgroundColor: '#FAF8F3' }}>
      ...
      <section id="actividades" className="py-24 px-6 lg:px-12" style={{ backgroundColor: '#FFF5EB' }}>
        <div className="max-w-6xl mx-auto">
          ...
          {/* De Vella a Bella Fest - card con link á páxina do festival */}
          <div className="p-10 rounded border-2" style={{ backgroundColor: '#FFFCF7', borderColor: '#E67747' }}>
            <div className="flex items-start space-x-5 mb-6">
              ...
              <div>
                ...
                <p className="text-sm font-semibold mb-4" style={{ color: '#E67747' }}>
                  30 de setembro – 5 de outubro de 2026 ·{' '}
                  <a href="https://anceu.com/" target="_blank" rel="noopener noreferrer" className="hover:underline">
                    Anceu Coliving
                  </a>
                  {' · '}Ponte Caldelas
                </p>
                <Link
                  ...
                  onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#6B8E5B'; }}
                >
                  Ver programa completo e máis info
                </Link>
              </div>
            </div>
          </div>
